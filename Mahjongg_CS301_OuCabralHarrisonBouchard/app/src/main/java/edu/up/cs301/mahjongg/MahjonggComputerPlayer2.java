...
/**
* A computer-version of a mahjongg-player.  Since this is such a simple game,
...
*/
public class MahjonggComputerPlayer2 extends MahjonggComputerPlayer1 {
	...
	private MahjonggState currentGameState = null;
	 ...
	 * 		the player's name
	 */
	public MahjonggComputerPlayer2(String name) {
		super(name);
	}
	...
	protected void receiveInfo(GameInfo info) {
		...
		else if (info instanceof MahjonggState) {
			// if we indeed have a mahjongg-state, update the GUI
			currentGameState = (MahjonggState)info;
			updateDisplay();
		}
	}
	...
	public void setAsGui(GameMainActivity a) {
		...
		activityForGui.setContentView(R.layout.mahjongg_human_player);
