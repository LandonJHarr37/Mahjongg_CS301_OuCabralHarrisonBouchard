...
/**
 * A mahjonggMoveAction is an action that is a "move" the game: either increasing
 ...
 */
public class MahjonggMoveAction extends GameAction {
	 ...
	 */
	public MahjonggMoveAction(GamePlayer player, boolean isPlus) {
		super(player);
		this.isPlus = isPlus;
	}
